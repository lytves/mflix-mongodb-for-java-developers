...
//        Bson oldProjection = new Document(new Document("title", 1));
    ...
    public List<Document> getMoviesByCast(String sortKey, int limit, int skip, String... cast) {
        ...
        //RESOLVED TODO> Ticket: Subfield Text Search - implement the expected cast
        // filter and sort
    ...
    public List<Document> getMoviesCastFaceted(int limit, int skip, String... cast) {
        ...
        // RESOLVED TODO > Ticket: Faceted Search - build the aggregation pipeline by adding all stages in the
        // correct order
